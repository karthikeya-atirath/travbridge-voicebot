...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      'is-user:dark flex w-fit max-w-full min-w-0 flex-col gap-2 overflow-hidden text-sm leading-relaxed tracking-tight md:text-base',
      'group-[.is-user]:ml-auto group-[.is-user]:rounded-[24px] group-[.is-user]:bg-[#0a4ca0] group-[.is-user]:px-5 group-[.is-user]:py-3.5 group-[.is-user]:text-white group-[.is-user]:shadow-sm',
      'group-[.is-assistant]:rounded-[24px] group-[.is-assistant]:border group-[.is-assistant]:border-neutral-100 group-[.is-assistant]:bg-white group-[.is-assistant]:px-5 group-[.is-assistant]:py-3.5 group-[.is-assistant]:text-neutral-800 group-[.is-assistant]:shadow-sm dark:group-[.is-assistant]:border-zinc-700/50 dark:group-[.is-assistant]:bg-zinc-800/80 dark:group-[.is-assistant]:text-neutral-200',
...
export const MessageBranchContent = ({ children, ...props }: MessageBranchContentProps) => {
  ...
  return childrenArray.map((branch: any, index: number) => (
    <div
      className={cn(
