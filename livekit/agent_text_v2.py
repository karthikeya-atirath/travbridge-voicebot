...
from aa_prompt import AGENT_INSTRUCTION, INITIAL_GREETING, TIME_GREETING
...
The greeting MUST be: "{TIME_GREETING}! Welcome to **Thomas Cook** — India's best travel company. I'm **{agent_display_name}**, your personal travel expert. How can we help you plan your next holiday today?"
"""
