...
class ChatHistory:
    ...
    def __init__(self, user_id="guest_user", customer_id="guest_user", device="VoiceBot", chat_channel="VoiceBot", agent_phone=None, customer_phone=None):
    ...
    def save_json(self):
        # JSON file saving disabled — data is persisted via DynamoDB
    ...
    def send_to_api(self):
        ...
        ChatDataUpdater.send_to_api(self.doc)
