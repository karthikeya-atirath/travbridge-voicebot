...
from prompts import get_agent_config, SESSION_INSTRUCTION
...
async def my_agent(ctx: agents.JobContext):
    ...
    try:
        ...
        full_instructions = SESSION_INSTRUCTION
        custom_prompt = ""
        opp_tool_calls = "all"
    ...
    if custom_prompt:
        ...
        await session.say(
            "Hi, I am Ezy, your AI Destination Expert. आप मुझसे English और Hindi दोनों में बात कर सकते हैं। How can I help you plan an amazing trip today?",
            allow_interruptions=False,
        )
...
if __name__ == "__main__":
    ...
    agents.cli.run_app(
        WorkerOptions(
            ...
            agent_name=os.environ.get("AGENT_NAME", "sotc-travel-bot"), 
