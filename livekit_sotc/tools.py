...
elastic_search_url_live_packages = "https://travbridge.atirath.com/sotc/SOTC_livepackages"
bogo_packages_url =  "https://travbridge.atirath.com/sotc/SOTC_get_all_BOGO_packages"
fare_calendar_url = "https://travbridge.atirath.com/sotc/SOTC_search_by_package_id"
...
search_packages_by_name_url = "https://travbridge.atirath.com/sotc/SOTC_search_by_package_name_v2"
# package_pricing_url = "https://travbridge.atirath.com/mcp/sotc/api/get_package_pricing"
package_pricing_url = "https://10.160.0.3:9004/mcp/sotc/api/get_package_pricing"
...
# Module-level storage for card_data (accessed by sotc_agent_text_v2._publish_tool_event)
...
def build_package_summaries(result: Any) -> List[str]:
    ...
    try:
        for package in (result or []):
            ...
            # Per-tier price breakdown with hotels (Standard=0, Value=1, Premium=2 for get_package_pricing)
...
async def get_package_pricing(
    ...
    try:
        ...
        payload = {
            ...
            "user_mobile_no": _sanitize("9999999999"),
