...
echo "Building voicebot-tcil..."
docker build -t voicebot-tcil:latest -f Dockerfile.livekit .

echo "Building voicebot-sotc..."
docker build -t voicebot-sotc:latest -f Dockerfile.livekit_sotc .
